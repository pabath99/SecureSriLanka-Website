...
const config = {
  title: 'SecureSriLanka',
  tagline: 'Connected devices made easy.',
  url: 'https://SecureSriLanka.net',
  baseUrl: '/',
  onBrokenLinks: 'warn',
  ...
  trailingSlash: false,
  projectName: 'SecureSriLanka-build',
     ...
     announcementBar: {
      ...
      footer: {
        ...
        links: [
          ...
          //     {
          //       label: 'Discord',
          //       href: 'https://discordapp.com/invite/SecureSriLanka',
          //     },
          //     {
          //       label: 'Twitter',
            ...
            items: [
              {
                ...
                href: 'https://github.com/awslabs/SecureSriLanka-build',
              }
            ],
          },
        ],
