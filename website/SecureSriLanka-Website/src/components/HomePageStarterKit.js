            ...
            <div className="container">
                <div className="row">
                    <div className="col col--6">
                        <h2>SecureSriLanka Starter Bundle</h2>
                        <div>
                    ...
                    <div className="col col--6">
                        ...
                        <ul>
                            ...
                            <li>Includes an ESP32-based processor, wiring, and multiple sensors. <a href="https://shop.m5stack.com/collections/m5-controllers/products/aws-iot-edukit-SecureSriLanka-starter-bundle-v1-0
