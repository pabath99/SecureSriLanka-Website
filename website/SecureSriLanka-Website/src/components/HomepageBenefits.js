                ...
                <div className="row">
                    ...
                    <div className="col benefits">
                        ...
                        <dl>
                            ...
                            <dd>SecureSriLanka does the undifferentiated heavy lifting for you so you can focus on your application.</dd>
                            <dt>Own your own data</dt>
                            <dd>With SecureSriLanka, you host your own infrastructure, code, and data.</dd>
                            ...
                            <dt>Pay-as-you-go</dt>
                            <dd>SecureSriLanka leverages the latest AWS Serverless and IOT services - only pay for what you use!</dd>
                        </dl>
                    </div>
                </div>
            </div>
